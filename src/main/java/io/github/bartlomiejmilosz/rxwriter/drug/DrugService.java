...
import io.github.bartlomiejmilosz.rxwriter.drug.database.DrugDatabase;
...
public class DrugService {
    ...
    private DispensableDrug convertRecord(DrugRecord record) {
        ...
        return new DispensableDrug(record.drugName(), classifications.toArray(
                new DrugClassification[0]),
